...
- Vendored files:
  ...
  - `wasm/vision_wasm_internal.bin` (unchanged WASM bytes, cache-friendly URL)
...
8da277a733926eacd0474b8704b36742d6ec3231c57a860c5b889dff8f1df886  wasm/vision_wasm_internal.bin
```
...
- File: `hand-gesture.bin` (unchanged model bytes, cache-friendly URL)
